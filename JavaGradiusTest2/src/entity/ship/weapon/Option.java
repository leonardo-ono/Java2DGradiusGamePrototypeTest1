...
public class Option extends Entity {
    ...
    public void fire() {
        ...
        if (ship.mainWeaponType == 1 || ship.mainWeaponType == 2) {
    ...
    public void update() {
        ...
        Point p = ship.trail.get(index * 8 * 4);
        x = p.x;
        y = p.y;
    }
