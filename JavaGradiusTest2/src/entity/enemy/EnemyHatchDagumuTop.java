 ...
 * @author admin
 */
public class EnemyHatchDagumuTop extends Entity {
    ...
    public EnemyHatchDagumuTop(View view, Ship ship, int x, int y) {
        super(view);
        this.ship = ship;
        this.x = x;
        this.y = y;
    ...
    @Override
    public void start() {
        loadFrame("enemy_hatch_dagumu_up_0");
        loadFrame("enemy_hatch_dagumu_up_1");
    }
    ...
    public void update() {
        ...
        if (x < (290 - enemyRushIndex * 8) && enemyRushIndex < 5) {
            Entity enemyRush = new EnemyRushTop(view, ship, (int) (x + 7), (int) y, 60, enemyRushIndex++, 0);
            enemyRush.start();
