 ...
 * @author admin
 */
public class EnemyDuckerDown extends Entity {
    ...
    public EnemyDuckerDown(View view, Terrain terrain, Ship ship, int x, int y, String color, int powerUpId) {
        super(view);
    ...
    @Override
    public void start() {
        loadFrame("enemy_ducker_" + color + "_down_left_0");
        loadFrame("enemy_ducker_" + color + "_down_left_1");
        loadFrame("enemy_ducker_" + color + "_down_left_2");
        loadFrame("enemy_ducker_" + color + "_down_right_0");
        loadFrame("enemy_ducker_" + color + "_down_right_1");
        loadFrame("enemy_ducker_" + color + "_down_right_2");
    }
    ...
    public void update() {
        ...
        if (walking) {
            ...
            frameIndexAux += 0.25;
            if (vx < 0 && x < walkStopPosition && persist < 3) {
                persist++;
                walking = false;
                frameIndexAux = 0;
            } 
            else if (vx > 0 && x > walkStopPosition && persist < 3) {
                persist++;
                walking = false;
                frameIndexAux = 0;
            } 
