 ...
 * @author admin
 */
public class EnemyDee01Top extends Entity {
    ...
    public EnemyDee01Top(View view, Ship ship, int x, int y, String color, int powerUpId) {
        super(view);
        this.ship = ship;
        this.x = x;
        this.y = y;
    ...
    @Override
    public void start() {
        loadFrame("enemy_cannon_" + color + "_up_0");
        loadFrame("enemy_cannon_" + color + "_up_1");
        loadFrame("enemy_cannon_" + color + "_up_2");
        loadFrame("enemy_cannon_" + color + "_up_3");
        loadFrame("enemy_cannon_" + color + "_up_4");
        loadFrame("enemy_cannon_" + color + "_up_5");
    }
    ...
    public void update() {
        ...
        double a = Math.atan((ship.x - x) / (sy - y));
