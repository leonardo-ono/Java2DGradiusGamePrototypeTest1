 ...
 * @author admin
 */
public class EnemyDee01 extends Entity {
    ...
    public EnemyDee01(View view, Ship ship, int x, int y) {
        super(view);
        this.ship = ship;
        this.x = x;
        this.y = y;
    ...
    @Override
    public void start() {
        loadFrame("enemy_cannon_blue_down_0");
        loadFrame("enemy_cannon_blue_down_1");
        loadFrame("enemy_cannon_blue_down_2");
        loadFrame("enemy_cannon_blue_down_3");
        loadFrame("enemy_cannon_blue_down_4");
        loadFrame("enemy_cannon_blue_down_5");
    }
